...
def main():
    ...
    seq_len = 200 # for ViT this is nr of patches per image, but is variable ??
    ...
    # Rearrange the mask
    print('head mask before rearrange:', head_mask)
    head_mask = rearrange_mask(head_mask, head_grads)
    print('head mask after rearrange:', head_mask)
